...
<script>
  ...
  import FreightAdd from '../../components/Freight/FreightAdd'
  ...
  export default {
    ...
    methods: {
      ...
      saveUserForm () {
        this.FormValue_Fre = true
        //发布搜索消息
        PubSub_Freight.publish('saveFormValue_Fre', this.FormValue_Fre)
      },
      //点击修改的时候 获得 Checkbox中 的属性
      upUserForm () {
        //发布订阅消息 修改
        PubSub_Freight.publish('multipleSelection', this.multipleSelection)
      },
    }
  }
</script>
